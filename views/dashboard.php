<div style="display: flex; gap: 25px; align-items: flex-start; width: 100%;">
    ...
    <div style="flex: 2; min-width: 0;"> <div style="margin-bottom: 20px; display: flex; gap: 10px; overflow-x: auto; padding-bottom: 5px;">
    ...
    <div style="flex: 1; min-width: 280px; background: #fff; padding: 20px; border-radius: 8px; border: 1px solid #ddd; position: sticky; top: 20px;">
        ...
        if (!empty($_SESSION['carrito'])): ?>
                ...
                ?>
                    <li style="border-bottom: 1px dashed #ccc; padding: 10px 0;">
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <a href="index.php?ruta=eliminar_item&id=<?php echo $id; ?>&dept=<?php echo $_GET['dept'] ?? 1; ?>" style="color: red; font-size: 12px;">Eliminar</a>
                        </div>
            ...
            <a href="index.php?ruta=cobrar" style="display: block; background: #4CAF50; color: white; text-align: center; padding: 10px; border-radius: 4px; text-decoration: none; font-weight: bold;">Cobrar Ticket</a>
        <?php else: ?>
            <p>Ticket vacío.</p>
        <?php endif; ?>
    </div>
